...
var RegexExtractor = require('./regex-extractor');
...
var LocationExtractor = function (_RegexExtractor) {
  _inherits(LocationExtractor, _RegexExtractor);
  ...
  function LocationExtractor() {
    ...
    _classCallCheck(this, LocationExtractor);

    parameters.dimension = 'system:location';
    parameters.regex = /([-+]?)([\d]{1,2})((\.)(\d+)(,))(\s*)(([-+]?)([\d]{1,3})((\.)(\d+))?)/g;
    return _possibleConstructorReturn(this, (LocationExtractor.__proto__ || Object.getPrototypeOf(LocationExtractor)).call(this, parameters));
  }

  /** @inheritDoc */


  _createClass(LocationExtractor, [{
    key: 'buildValue',
    value: function buildValue(value) {
      logger.debug('buildValue', value);
      var coordinates = value[0].split(',');
